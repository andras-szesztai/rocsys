...
export const ReadAllDevicesDocument = gql`
...
/**
 * __useReadAllDevicesQuery__
 *
 * To run a query within a React component, call `useReadAllDevicesQuery` and pass it any options that fit your needs.
 * When your component renders, `useReadAllDevicesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useReadAllDevicesQuery(baseOptions?: Apollo.QueryHookOptions<ReadAllDevicesQuery, ReadAllDevicesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ReadAllDevicesQuery, ReadAllDevicesQueryVariables>(ReadAllDevicesDocument, options);
      }
export function useReadAllDevicesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ReadAllDevicesQuery, ReadAllDevicesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ReadAllDevicesQuery, ReadAllDevicesQueryVariables>(ReadAllDevicesDocument, options);
        }
export type ReadAllDevicesQueryHookResult = ReturnType<typeof useReadAllDevicesQuery>;
export type ReadAllDevicesLazyQueryHookResult = ReturnType<typeof useReadAllDevicesLazyQuery>;
export type ReadAllDevicesQueryResult = Apollo.QueryResult<ReadAllDevicesQuery, ReadAllDevicesQueryVariables>;