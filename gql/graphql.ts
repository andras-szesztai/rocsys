...
export type ReadDeviceQuery = { __typename?: 'query_root', device: Array<{ __typename?: 'device', id: any, name: string, description?: string | null, device_type: { __typename?: 'device_type', name: string } }> };
